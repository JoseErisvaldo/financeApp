...
export default function useTransactionsHooks(
  ...
  return useSuspenseQuery({
    ...
    /* So serve se for useQuery --- placeholderData: keepPreviousData, // controla o que mostrar na UI enquanto busca os dados, mantendo os dados anteriores para evitar "piscar" a UI*/
